...
<div id="container">
	<div id="header">
		User Task Form: manualbookingprocess.ProcessPayment
	</div>
	<div id="content">
		...
		<fieldset>
            <legend>Task Info</legend>
            	...
            	<div class="div_checkbox"><![CDATA[employeebookingrole]]></div>
		...
		<fieldset>
            <legend>Task Inputs</legend>
                            		...
                            		<div class="div_checkbox">
                              		<![CDATA[#{booking.applicant.name}]]>
                            		</div>
                            		<label for="name">Booking</label>
                            		<div class="div_checkbox">
                              		<![CDATA[#{booking.bookingId}]]>
                            		</div>
          ...
          <fieldset>
            <legend>Task Outputs</legend>
                            		...
                            		<div class="div_texbox">
                              		<input name="Status" type="text" class="textbox" id="Status" value="${Status}" />
                            		</div>
